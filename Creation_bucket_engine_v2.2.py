...
# Example: bucket_engine_v2_20260817_181530.log
...
def print_configuration_report():
    """Print only database configuration errors; otherwise print one success line."""
    missing_tables=[]
    missing_columns=[]
    ...
    if not missing_tables and not missing_columns:
        print("[OK] Database configuration validation successful")
    else:
        for table in missing_tables:
            print(f"[MISSING TABLE]   {DB_SCHEMA}.{table}")
        for item in missing_columns:
            print(f"[MISSING COLUMN]  {DB_SCHEMA}.{item}")
...
def main():
    print("Bucket Engine V2.0 started")

    logger.info('='*100)
    logger.info('Bucket Engine V2.0 starting')
    ...
    try:
        ...
        print("")
        print("Bucket Engine V2.0 NOT started because database configuration is incomplete.")
        sys.exit(1)
    except Exception as e:
        ...
        print(f"Log File      : {LOG_FILE}")
        print("")
        print("Bucket Engine V2.0 NOT started.")
        sys.exit(1)
    ...
    try:
        ...
        logger.info('Bucket Engine V2.0 completed')
        ...
        if total == 0:
            print("Bucket Engine V2.0 completed - No pending requests")
        elif success == total:
            print("Bucket Engine V2.0 completed successfully")
        elif failed == total:
            print("Bucket Engine V2.0 completed with errors")
        else:
